    ...
    return (
        <div>
            <div className="lg:flex gap-5 e-full lg:w-[90%] lg:mx-auto bg-white shadow-lg rounded-xl p-10 mb-10">
                <img className=' shadow p-3 object-contain rounded-xl lg:w-[500px] ' src={Doctor} alt="" />
                ...
                <div className="w-full lg:w-[50%] h-full p-4">
                    ...
                    <div className=" mt-10">
                        <div className='space-y-3 lg:flex gap-4 items-center lg:justify-center'>
                            <a className='inline-flex items-center gap-2' target='_blank' title='Front end' href="https://github.com/MuhammadSaikat25/Hello-Doctor">Front End
                                <span>
